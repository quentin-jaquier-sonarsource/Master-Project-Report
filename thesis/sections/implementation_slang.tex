...
\begin{enumerate}
	...
	caption=Example of local scope inside a loop that can shadow a field]{code/local-scope-in-while.scala}
	...
	caption=Example of pointer used as a parameter of a function call]{code/function-invocation-support.scala}
