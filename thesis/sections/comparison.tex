...
In listing \ref{lst:annotated-code} for example, the function \emph{f} is guaranteed to never return null, and the callee can directly dereference the result of this function without checking it for null. 
...
Table \ref{table:slang_vs_spotbugs} shows a subset of more than 30 rules related to null pointer dereference that are reported by SpotBugs. 
...
\begin{figure}[h]
	...
	\begin{tabular}{cc}
		\multicolumn{1}{c}{\lstinputlisting[numbers=none]{code/abstract-class-1.scala}} & \multicolumn{1}{c}{\lstinputlisting[numbers=none]{code/abstract-class-2.scala}} \\
	\end{tabular}
\end{figure}
