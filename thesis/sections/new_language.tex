...
There is no clear solution to this trade-off, we are going to target a rate of less than $10\%$ of false positive for our work.
...
With this simple step, we are already able to enable new checks related to comments, like the tracking of \emph{TODO} and reporting code that is commented.
