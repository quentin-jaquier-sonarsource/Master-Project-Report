...
The key novel ideas are the representation of unknown expressions by natives elements in \slang{}, and the notion of unreliable basic block for dataflow analysis.
...
The results show that we are able to find real issues with very low false positive rate, and also reach the same precision as the implementation on the original language.
\end{abstract}
